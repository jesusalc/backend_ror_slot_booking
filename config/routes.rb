Rails.application.routes.draw do
  namespace :api do
    namespace :v1 do
      ...
      resources :booked_slots, only: %i[create index], path: 'booked/slots', to: 'slots#booked_slots' # Changed '/booked_slots' to 'booked/slots'
      ...
      resources :available_slots, only: %i[create index], path: 'available/slots', to: 'opens#available_slots' # Changed '/available_slots' to 'available/slots'
